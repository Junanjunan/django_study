...
def stream_video(request, video_file_path):
    ...
    if 'HTTP_RANGE' in request.META:
        ...
        response.status_code = 206
        request.META['HTTP_RANGE'] = 'bytes=326402048-'
        response['HTTP_RANGE'] = request.META['HTTP_RANGE']
        response['Content-Length'] = 329562834 - 326402048 + 1
        response['Content-Range'] = 'bytes 326402048-329562834'
